...
class StandardPlanRateService {
  ...
  static final _defaults = [
    ...
    // ── OEM integrations ─────────────────────────────────────────────────────
    StandardPlanRate(planKey: 'Ford OEM',        keyword: 'ford',            yourCost:  0.00, sortOrder: 10),
    StandardPlanRate(planKey: 'GM OEM',          keyword: 'geotab gm',       yourCost:  0.00, sortOrder: 11),
    StandardPlanRate(planKey: 'Mack OEM',        keyword: 'geotab mack',     yourCost:  0.00, sortOrder: 12),
    StandardPlanRate(planKey: 'Mercedes OEM',    keyword: 'mercedes',        yourCost:  0.00, sortOrder: 13),
    StandardPlanRate(planKey: 'Navistar OEM',    keyword: 'navistar',        yourCost:  0.00, sortOrder: 14),
    StandardPlanRate(planKey: 'Volvo OEM',       keyword: 'geotab volvo',    yourCost:  0.00, sortOrder: 15),
    StandardPlanRate(planKey: 'Freightliner OEM',keyword: 'freightliner',    yourCost:  0.00, sortOrder: 16),
    StandardPlanRate(planKey: 'Stellantis OEM',  keyword: 'stellantis',      yourCost:  0.00, sortOrder: 17),
    StandardPlanRate(planKey: 'SW3',             keyword: 'sw3',             yourCost:  0.00, sortOrder: 18),
    // ── AEMP / telematics add-ons ────────────────────────────────────────────
    StandardPlanRate(planKey: 'AEMP',            keyword: 'aemp',            yourCost:  0.00, sortOrder: 20),
    StandardPlanRate(planKey: 'CAT AEMP',        keyword: 'cat aemp',        yourCost:  0.00, sortOrder: 21),
    StandardPlanRate(planKey: 'JD AEMP',         keyword: 'john deere',      yourCost:  0.00, sortOrder: 22),
    StandardPlanRate(planKey: 'Komatsu AEMP',    keyword: 'komatsu',         yourCost:  0.00, sortOrder: 23),
  ];
